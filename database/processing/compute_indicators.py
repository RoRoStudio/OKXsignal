...
def update_candles_table(df_final: pd.DataFrame):
    ...
    s_buffer = time.time()
    buffer = io.StringIO()
    df_final.to_csv(buffer, sep="|", header=False, index=False, na_rep="\\N", float_format="%.10f")
    buffer.seek(0)
    e_buffer = time.time() - s_buffer
    print(f"🧃 Prepared CSV buffer for COPY in {e_buffer:.3f}s")

    update_query = """
    UPDATE public.candles_1h AS c
    SET 
      -- 1H columns
    ...
    FROM
      (VALUES %s) AS d(
        ...
        bollinger_lower_1h,
        bollinger_width_1h,
        keltner_channel_upper_1h,
        keltner_channel_lower_1h,
        obv_1h,
        obv_slope_1h,
        money_flow_index_1h,
        donchian_channel_upper_1h,
        donchian_channel_lower_1h,
        supertrend_upper_1h,
        supertrend_lower_1h,
        ichimoku_cloud_upper_1h,
        ichimoku_cloud_lower_1h,
        parabolic_sar_1h,
        perf_vs_btc_pct_1h,
        perf_vs_eth_pct_1h,
        fib_level_0_236_1h,
        ...
        future_return_1w_pct,
        future_return_2w_pct,
        market_regime_1h,
        hour_of_day,
        day_of_week,
        ...
        bollinger_lower_4h,
        bollinger_width_4h,
        keltner_channel_upper_4h,
        keltner_channel_lower_4h,
        obv_4h,
        obv_slope_4h,
        money_flow_index_4h,
        donchian_channel_upper_4h,
        donchian_channel_lower_4h,
        supertrend_upper_4h,
        supertrend_lower_4h,
        ichimoku_cloud_upper_4h,
        ichimoku_cloud_lower_4h,
        parabolic_sar_4h,
        perf_vs_btc_pct_4h,
        perf_vs_eth_pct_4h,
        fib_level_0_236_4h,
        ...
        bollinger_lower_1d,
        bollinger_width_1d,
        keltner_channel_upper_1d,
        keltner_channel_lower_1d,
        obv_1d,
        obv_slope_1d,
        money_flow_index_1d,
        donchian_channel_upper_1d,
        donchian_channel_lower_1d,
        supertrend_upper_1d,
        supertrend_lower_1d,
        ichimoku_cloud_upper_1d,
        ichimoku_cloud_lower_1d,
        parabolic_sar_1d,
        perf_vs_btc_pct_1d,
        perf_vs_eth_pct_1d,
        fib_level_0_236_1d,
