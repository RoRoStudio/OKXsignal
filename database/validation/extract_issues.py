...
from database.validation.validation_utils import load_config, get_db_connection, fetch_data
...
def get_computation_function(validator_name, issue_type):
    ...
    if validator_name == "Volatility":
        from database.validation.validate_volatility import calculate_atr, calculate_true_range, calculate_bollinger_bands
        ...
        from database.validation.validate_momentum import calculate_rsi, calculate_macd, calculate_stochastic
        ...
        from database.validation.validate_volume_indicators import calculate_obv, calculate_money_flow_index
