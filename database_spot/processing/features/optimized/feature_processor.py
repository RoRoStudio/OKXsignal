...
from database_spot.processing.features.optimized import (
...
from database_spot.processing.features.config import (
    PRICE_ACTION_PARAMS,
    MOMENTUM_PARAMS,
    VOLATILITY_PARAMS,
    VOLUME_PARAMS,
...
class OptimizedFeatureProcessor:
    ...
    def __init__(self, use_numba=True, use_gpu=False):
        ...
        if self.gpu_available and GPU_AVAILABLE:
            try:
                from database_spot.processing.features.optimized.gpu_functions import is_gpu_available
    ...
    def process_features(self, price_data, enabled_features=None, perf_monitor=None):
        ...
        from database_spot.processing.features.utils import validate_future_features
    ...
    def process_all_features(self, price_data, perf_monitor=None):
        ...
        try:
            ...
            from database_spot.processing.features.multi_timeframe import MultiTimeframeFeatures
