...
MIN_CANDLES_REQUIRED = 640  # Minimum candles needed for reliable calculation
ROLLING_WINDOW = 450  # Default window size for rolling updates (set actual value in config.ini)
...
class ConfigManager:
    ...
    def _check_gpu_availability(self):
        ...
        try:
            ...
            logging.info(f"GPU detected: {device_info}, Memory: {total_memory:.2f} GB")
            return True
